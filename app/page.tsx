...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── AREA ── */}
      <section className="py-12 sm:py-14" style={{background:'#EFF6FF'}}>
        <div className="container-page">
          <div className="text-center mb-8">
            <h2 className="font-extrabold text-xl text-gray-900 mb-2">Cari Loker per Wilayah</h2>
            <p className="text-sm text-gray-500">Pilih wilayah terdekat Anda</p>
          </div>
      ...
      <section className="py-12 sm:py-14 bg-white">
        <div className="container-page">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500">Temukan loker sesuai bidang Anda</p>
          </div>
          <div className="flex flex-wrap justify-center gap-2.5">
            {CATEGORIES.map(cat => (
              <Link key={cat} href={`/loker?category=${encodeURIComponent(cat)}`}
                className="px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 no-underline hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-colors">
                {cat}
              </Link>
            ))}
          </div>
      ...
      <section className="hero-gradient py-14 sm:py-16">
        <div className="container-page max-w-2xl text-center">
          <Building2 size={44} color="white" className="mx-auto mb-5 opacity-70"/>
          <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl text-white mb-4">
            Anda Punya Lowongan?
          </h2>
          <p className="text-blue-200 mb-8 leading-relaxed text-sm sm:text-base max-w-md mx-auto">
      ...
      <section className="py-14 sm:py-16 bg-white">
        <div className="container-page">
          <h2 className="font-extrabold text-xl text-gray-900 text-center mb-10">
