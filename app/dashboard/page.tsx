...
import { Briefcase, Plus, Eye, TrendingUp, Users, CheckCircle, Clock, XCircle, Edit, Trash2, Star, Building2, ChevronRight, LogOut, Settings, Bell } from 'lucide-react'
      ...
      <main className="flex-1 lg:ml-64">
        ...
        <div className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500">Selamat datang, PT Batik Mahkota</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Link href="/dashboard/pasang-loker" className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-white" style={{background:'var(--primary)'}}>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-2xl p-6 flex flex-col md:flex-row items-center gap-5" style={{background:'linear-gradient(135deg, var(--primary), #1a6ab5)'}}>
